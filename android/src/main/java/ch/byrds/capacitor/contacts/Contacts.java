...
public class Contacts extends Plugin {
    ...
    public void getContacts(PluginCall call) {
        ...
        Cursor contactsCursor = contentResolver.query(ContactsContract.Data.CONTENT_URI, projection, selection,
                selectionArgs, null);
        ...
        if (contactsCursor != null && contactsCursor.getCount() > 0) {
            ...
            while (contactsCursor.moveToNext()) {
                ...
                String contactId = contactsCursor
                        .getString(contactsCursor.getColumnIndex(ContactsContract.Data.CONTACT_ID));
                ...
                if (!contactsById.containsKey(contactId)) {
                    ...
                    String displayName = contactsCursor
                            .getString(contactsCursor.getColumnIndex(ContactsContract.Contacts.DISPLAY_NAME));
                    jsContact.put(DISPLAY_NAME, displayName);

                    String givenName = contactsCursor.getString(
                    ...
                    String middleName = contactsCursor.getString(
                            contactsCursor.getColumnIndex(ContactsContract.CommonDataKinds.StructuredName.MIDDLE_NAME));
                    jsContact.put(MIDDLE_NAME, middleName);

                    String familyName = contactsCursor.getString(
                    ...
                    jsContact.put(SORT_FIELD, familyName);
                ...
                if (jsContact != null) {
                    String mimeType = contactsCursor
                            .getString(contactsCursor.getColumnIndex(ContactsContract.Data.MIMETYPE));
                    String data = contactsCursor.getString(
                            contactsCursor.getColumnIndex(ContactsContract.CommonDataKinds.Contactables.DATA));
                    int type = contactsCursor
                            .getInt(contactsCursor.getColumnIndex(ContactsContract.CommonDataKinds.Contactables.TYPE));
                    ...
                    switch (mimeType) {
                        ...
                        // String encodedThumbnailPhoto = Base64.encodeToString(thumbnailPhoto,
                        // Base64.NO_WRAP);
                        // jsContact.put(PHOTO_THUMBNAIL, "data:image/png;base64," +
                        // encodedThumbnailPhoto);
                        // }
                        // break;
                    }
    ...
    public void getGroups(PluginCall call) {
        ...
        Cursor dataCursor = getContext().getContentResolver().query(ContactsContract.Groups.CONTENT_URI, null, null,
                null, null);
        ...
        while (dataCursor.moveToNext()) {
            ...
            jsGroup.put("accountType",
                    dataCursor.getString(dataCursor.getColumnIndex(ContactsContract.Groups.ACCOUNT_TYPE)));
            jsGroup.put("accountName",
                    dataCursor.getString(dataCursor.getColumnIndex(ContactsContract.Groups.ACCOUNT_NAME)));
    ...
    public void saveContact(PluginCall call) throws JSONException {
        ...
        // TODO: add missing: birthday, social profiles, nickname, name prefix, url
        // addresses
        ...
        // intent.putExtra(ContactsContract.Intents.Insert.DEPARTMENT,
        // call.getString("departmentName", ""));
        ...
        if (addresses.size() > 0) {
            ...
            String postal = postalObject.getString("street", "") +
                    ", " +
