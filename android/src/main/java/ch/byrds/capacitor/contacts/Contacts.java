...
// TODO THESE ARE NOT WORKING WELL
            String givenName = contactsCursor.getString(contactsCursor
              .getColumnIndex(ContactsContract.CommonDataKinds.StructuredName.GIVEN_NAME));
            jsContact.put(GIVEN_NAME, givenName);

            String middleName = contactsCursor.getString(contactsCursor
              .getColumnIndex(ContactsContract.CommonDataKinds.StructuredName.MIDDLE_NAME));
            jsContact.put(MIDDLE_NAME, middleName);

            String familyName = contactsCursor.getString(contactsCursor
            ...
            switch (mimeType) {
              ...
              case Organization.CONTENT_ITEM_TYPE:
                ...
                if (this.orgSort == true) {
                  jsContact.put(DISPLAY_NAME, data);
                }
